...
class FloodDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        input_array_normalized[1,:,:] = (inputs[1,:,:] - np.mean(flow_mean)) / np.mean(flow_std)
...
def load_unet_model(model_class, model_path, in_channels=2, out_channels=1, initial_filters=32, device=None):
    """
...
flow_mean_file = f"/p/vast1/lazin1/UNet_inputs/mean_stds/streamflow_mean.npy"
flow_std_file = f"/p/vast1/lazin1/UNet_inputs/mean_stds/streamflow_std_dev.npy"
...
if sys.argv[1] == "train":
    ...
    for e, EVENT_STR in enumerate(EVENT_STRS):
        ...
        events = pd.read_csv(event_file, header=None).to_numpy()
        model_dir = f"/p/vast1/lazin1/UNet_trains/Event_wise_DEM_streamflow/{EVENT_STR}"
        ...
        events_file = f"/usr/workspace/lazin1/anaconda_dane/envs/RAPID/Codes/combined_{EVENT_STR}_No_Threshold.csv" #f"/usr/workspace/lazin1/anaconda_dane/envs/RAPID/Codes/combined.csv"  #'/usr/workspace/lazin1/anaconda_dane/envs/RAPID/EVENTS/combined.csv'
        ...
        for tile_name in tile_names:
            ...
            # day1_prec.append(f"/p/vast1/lazin1/UNet_inputs/Geotiff_var/1D_prec/{tile_str}/1day_prec_{tile_name}")
            # day5_prec.append( f"/p/vast1/lazin1/UNet_inputs/Geotiff_var/5D_prec/{tile_str}/5day_prec_{tile_name}")
            streamflow.append(f"/p/vast1/lazin1/UNet_inputs/Geotiff_var/streamflow/{tile_str}/streamflow_{tile_name}")
    ...
    model_path = f"/p/vast1/lazin1/UNet_trains/Event_wise_DEM_streamflow/Mississippi_20190617_5E5F_non_flood/unet_model_fold_5.pt" #f"/p/vast1/lazin1/UNet_trains/Mississippi_20190617_5E5F_non_flood_event_wise/unet_model_fold_5.pt" #"/p/vast1/lazin1/UNet_trains/All_events_shuffled/unet_model_fold_8_9.pt"  # Path to the trained model

...
# for e, EVENT_STR in enumerate(EVENT_STRS):
    ...
    model_dir = f"//p/vast1/lazin1/UNet_trains/Sonoma_event2_org_code_output_not_nprmalized_dem_prec"
    ...
    for e, event in enumerate(events, start=1):
        ...
        k_fold_cross_validation_based_on_events(model, events, events_file, dataset, num_epochs=10, batch_size=128, checkpoint_path=checkpoint_path, device=device, device_ids=device_ids)
    ...
    output_geotiff_dir = f"/p/vast1/lazin1/UNet_Geotiff_output/Sonoma_event2_org_output_not_normalized_prec_dem"
    ...
    model_path = f"/p/vast1/lazin1/UNet_trains/Sonoma_event2_org_code_output_not_nprmalized_dem_prec/unet_model_fold_7.pt" #f"/p/vast1/lazin1/UNet_trains/Mississippi_20190617_5E5F_non_flood_event_wise/unet_model_fold_5.pt" #"/p/vast1/lazin1/UNet_trains/All_events_shuffled/unet_model_fold_8_9.pt"  # Path to the trained model

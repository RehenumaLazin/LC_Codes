...
events_file = '/usr/workspace/lazin1/anaconda_dane/envs/RAPID/EVENTS/flood_events.csv'
...
# TARGET_RASTER_DIR = f"/p/lustre1/lazin1/RAPID_Archive_Flood_Maps/Tile_No_Threshold_{EVENT_STR}" #'/p/lustre1/lazin1/RAPID_Archive_Flood_Maps/Tile_No_Threshold_Mississippi_20190617_5E5F_non_flood'  # Reference raster for extent and resolution
    ...
    # Input files
    cropped_outpur_dir = f"/p/lustre2/lazin1/DEM"  # Folder to save the cropped DEMs  #Mississippi_20190617_5E5F_cropped_dems_non_flood
    ...
    low_res_ds = gdal.Open(raster_path)
    ...
    cropped_file = os.path.join(cropped_outpur_dir, event + '.tif')

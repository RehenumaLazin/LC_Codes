...
# Input files
cropped_outpur_dir = f"/p/vast1/lazin1/UNet_inputs/Geotiff_var/cropped_flowline/Sonoma/"  # Folder to save the cropped DEMs  #Mississippi_20190617_5E5F_cropped_dems_non_flood
...
temp_raster_path = f"/usr/workspace/lazin1/anaconda_dane/envs/RAPID/Codes/Sonoma_shapefile/Sonoma_reaches/Sonoma_extent_reach.tif"
date_format = "%Y%m%d"
...
for reference_raster_file in geo_files:
    ...
    output_geotiff = os.path.join(cropped_outpur_dir, 'flowline_' + reference_raster_file.split("/")[-1])

...
events_file = f"/usr/workspace/lazin1/anaconda_dane/envs/RAPID/Codes/Sonoma_shapefile/Tile_Sonoma_hourly_event2_test.csv"
...
if sys.argv[1] == "train":
    ...
    # print(dataset[0])
    kfold_train(dataset, k_folds=3, batch_size=10, model_dir=model_dir, num_epochs=10)

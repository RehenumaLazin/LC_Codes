...
python -m torch.distributed.launch --use_env script_LSTM_UNet.py train

# python -m torch.distributed.launch --use_env --nproc_per_node=4 --nnodes=1 --node_rank=0 script_LSTM_UNet.py train
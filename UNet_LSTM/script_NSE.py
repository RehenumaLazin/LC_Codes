...
model_dir = f"/p/vast1/lazin1/UNet_trains/Sonoma_event2_output_prec_dem_LC_HOURLY_script_NSE"
...
if sys.argv[1] == "train":
    ...
    # print(dataset[0])
    kfold_train(dataset, k_folds=11, prev_trained_days=6, batch_size=16, model_dir=model_dir, num_epochs=2)
    ...
    output_geotiff_dir =f"/p/vast1/lazin1/UNet_Geotiff_output/Sonoma_event2_prec_dem_LC_Hourly_script_NSE_fold11"

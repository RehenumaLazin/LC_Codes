...
output_geotiff_dir = f"/p/vast1/lazin1/UNet_inputs/Geotiff_var/5D_prec/Sonoma/event1/" #Harvey_D374'  #5E5F
...
for f in files:        
    ...
    output_geotiff = f"{output_geotiff_dir}/5day_prec_"+ f.split("/")[-1]
    ...
    if not os.path.exists(temp_raster_path):
        ...
        precip_5day= data_var.sum(dim="time")

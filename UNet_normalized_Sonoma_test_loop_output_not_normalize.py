...
# for e, EVENT_STR in enumerate(EVENT_STRS):
    ...
    model_dir = f"//p/vast1/lazin1/UNet_trains/Sonoma_event2_output_not_normalized_retrain"
    ...
    output_geotiff_dir = f"/p/vast1/lazin1/UNet_Geotiff_output/Sonoma_event2_output_not_normalized_retrain"
    ...
    model_path = f"/p/vast1/lazin1/UNet_trains/Sonoma_event2_output_not_normalized_retrain/unet_model_fold_7.pt" #f"/p/vast1/lazin1/UNet_trains/Mississippi_20190617_5E5F_non_flood_event_wise/unet_model_fold_5.pt" #"/p/vast1/lazin1/UNet_trains/All_events_shuffled/unet_model_fold_8_9.pt"  # Path to the trained model

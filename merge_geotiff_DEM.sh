...
# Output directory
output_geo_dir="/p/lustre2/lazin1" #"/p/vast1/lazin1/UNet_Geotiff_output_event_wise_prec_5d_doubled"  #/p/vast1/lazin1/UNet_Geotiff_output_event_wise" #/p/vast1/lazin1/UNet_Geotiff_output" #/p/vast1/lazin1/UNet_Geotiff_output_event_wise
...
event_dir="$output_geo_dir/cropped_dems_$event"
#!/bin/bash
...
prefix="dem_flood_WM_S1A_IW_GRDH_1SDV_20190617T000326_20190617T000351_027712_0320C9_3AC6_crop_"

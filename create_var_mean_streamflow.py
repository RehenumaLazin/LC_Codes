...
output_mean_file = f"/p/vast1/lazin1/UNet_inputs/mean_stds/streamflow_mean.npy"
output_std_file = f"/p/vast1/lazin1/UNet_inputs/mean_stds/streamflow_std_dev.npy"

...
# for e, EVENT_STR in enumerate(EVENT_STRS):
    ...
    model_dir = f"//p/vast1/lazin1/UNet_trains/Sonoma_event2_test"
    ...
    os.makedirs(f"/p/vast1/lazin1/UNet_Geotiff_output/Sonoma_event3", exist_ok=True)
    for tile_name in tile_names:
        tile_str = tile_name.split("Sonoma")[-1]#tile_name.split("crop")[0][:-1] 
        event = tile_name.split("/")[-1].split("_")[0]
        date = tile_name.split("/")[-1].split("_")[1]
    ...
    model_path = f"/p/vast1/lazin1/UNet_trains/Sonoma_event2/unet_model_fold_7.pt" #f"/p/vast1/lazin1/UNet_trains/Mississippi_20190617_5E5F_non_flood_event_wise/unet_model_fold_5.pt" #"/p/vast1/lazin1/UNet_trains/All_events_shuffled/unet_model_fold_8_9.pt"  # Path to the trained model

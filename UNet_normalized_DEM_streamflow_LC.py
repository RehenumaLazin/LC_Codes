...
class FloodDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        input_array_normalized[2,:,:] = (inputs[2,:,:] - np.mean(flow_mean)) / np.mean(flow_std)  
...
if sys.argv[1] == "train":
    ...
    for e, EVENT_STR in enumerate(EVENT_STRS):
        ...
        events = pd.read_csv(event_file, header=None).to_numpy()
        model_dir = f"/p/vast1/lazin1/UNet_trains/Event_wise_DEM_streamflow_LC/{EVENT_STR}"

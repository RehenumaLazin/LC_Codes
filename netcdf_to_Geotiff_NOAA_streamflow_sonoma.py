...
TARGET_RASTER_DIR = f"/p/vast1/lazin1/UNet_inputs/Geotiff_var/WM/Tile_Sonoma/event3/" #f"/p/lustre1/lazin1/RAPID_Archive_Flood_Maps/Tile_No_waterbody/{event}"#f"/p/lustre1/lazin1/RAPID_Archive_Flood_Maps/Tile_{event}"
...
output_geotiff_dir = f"/p/vast1/lazin1/UNet_inputs/Geotiff_var/streamflow/Sonoma" #streamflow_No_Waterbody  #5E5F #/p/vast1/lazin1/UNet_inputs/Geotiff_var/streamflow_No_Waterbody

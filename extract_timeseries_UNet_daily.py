...
for event_index in range(len(start_dates)):
    ...
    tif_dir = f"/p/vast1/lazin1/UNet_Geotiff_output/Sonoma_event2_prec_dem_retrain_multiple//" #f"/p/lustre1/lazin1/flood/Sonoma/RussianRiver_{start_str}_{end_str}/" 

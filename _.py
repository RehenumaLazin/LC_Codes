...
for event_index in range(len(start_dates)):
    ...
    tif_dir = f"/p/vast1/lazin1/UNet_Geotiff_output/Sonoma_event2_prec_dem_LC_Hourly_script_LSTM_UNet_fold11//" #f"/p/lustre1/lazin1/flood/Sonoma/RussianRiver_{start_str}_{end_str}/" 
    ...
    for sta in stationIDs:
        ...
        output_filename = f"/p/vast1/lazin1/UNet_Geotiff_output/csv/event{event_index+1}/{sta}_UNet_daily_multiple.csv"

...
# for e, EVENT_STR in enumerate(EVENT_STRS):
    ...
    model_dir = f"//p/vast1/lazin1/UNet_trains/Sonoma_event2_org_code_output_not_nprmalized"
    ...
    output_geotiff_dir = f"/p/vast1/lazin1/UNet_Geotiff_output/Sonoma_event2_org_output_not_normalized_fold4"
    ...
    model_path = f"/p/vast1/lazin1/UNet_trains/Sonoma_event2_org_code_output_not_nprmalized/unet_model_fold_4.pt" #f"/p/vast1/lazin1/UNet_trains/Mississippi_20190617_5E5F_non_flood_event_wise/unet_model_fold_5.pt" #"/p/vast1/lazin1/UNet_trains/All_events_shuffled/unet_model_fold_8_9.pt"  # Path to the trained model

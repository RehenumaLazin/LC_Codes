...
# Example usage
geotiff_files = day30_prec  # Replace with actual paths
output_mean_file = f"/p/vast1/lazin1/UNet_inputs/mean_stds/day30_prec_mean.npy"
output_std_file = f"/p/vast1/lazin1/UNet_inputs/mean_stds/day30_prec_std_dev.npy"
